var periodDateTextNode = document.querySelector('#gobartable').rows[0].cells[0].getElementsByTagName('div')[0];
var currentDateTextNode = document.querySelector('#gobartable').rows[1].cells[0].getElementsByTagName('div')[0];
